...
datafilename='2kV_LangPort4_0p5ms_1msGas_8shots_bdot_10142019.h5'
#load hdf5 file
...
avebspec_frombdot = np.zeros([4,3,fsize])
avebspec_direct = np.zeros([4,3,fsize])
avebmagspec = np.zeros([4,fsize])
