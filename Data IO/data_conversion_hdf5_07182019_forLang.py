...
import load_picoscope_bmx_07182019 as load
import numpy as np

filepath='C:\\Users\\dschaffner\\Dropbox\\Data\\BMPL\\BMX\\2019\\Correlation Campaign\\Encoding Converted for PC\\07182019\\processed\\'
filename='2kV_LangPort4_0p5ms_stuffdelay_33shots_Langbiasvoltscan_07182019'
import h5py
...
for shot in np.arange(1,shotnum+1):
    ...
    lang_isat[shot-1,:]=data[5]*10.0


lang_isat=h5f.create_dataset('lang_isat',data=lang_isat)

import matplotlib.pylab as plt
plt.plot(h5f['lang_isat'][6,:])
plt.plot(h5f['lang_isat'][7,:])