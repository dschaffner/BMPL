...
datadirectory='C:\\Users\\dschaffner\\Dropbox\\Data\\BMPL\\BMX\\2024\\07102024\\'

#numskipped=len(skipshots)
#numshots=maxshot-(startshot-1)-numskipped

runfilename = 'Dataset4_wiretarget_1kV_1msstuff_4kAwire_40shots' #shots 18 to 68 skip 26,33,34,41,45,51,52,62,65,66,67
...
testpicoshot=pd.read_csv(datadirectory+'\pico1\\20240710-0001 ('+str(6)+').csv',header=[0],skiprows=[1])
...
startshot=18
maxshot=68
skipshots=[26,33,34,41,45,51,52,62,65,66,67]
### Extract PICO 1 ###
savenumber=0
for shot in np.arange(startshot,maxshot):
    if shot in skipshots:
        continue
    #Load Picoscope file
    pico=pd.read_csv(datadirectory+'\Pico1\\20240710-0001 ('+str(shot)+').csv',header=[0],skiprows=[1])
...
for shot in np.arange(startshot,maxshot):
    if shot in skipshots:
        continue
    #Load Picoscope file
    pico=pd.read_csv(datadirectory+'\Pico2\\20240710-0001 ('+str(shot)+').csv',header=[0],skiprows=[1])
...
for shot in np.arange(startshot,maxshot):
    if shot in skipshots:
        continue
    #Load Picoscope file
    pico=pd.read_csv(datadirectory+'\Pico3\\20240710-0001 ('+str(shot)+').csv',header=[0],skiprows=[1])
...
for shot in np.arange(startshot,maxshot):
    if shot in skipshots:
        continue
    #Load Picoscope file
    pico=pd.read_csv(datadirectory+'\Pico4\\20240710-0001 ('+str(shot)+').csv',header=[0],skiprows=[1])
...
for shot in np.arange(startshot,maxshot):
    if shot in skipshots:
        continue
    #Load Picoscope file
    pico=pd.read_csv(datadirectory+'\Pico5\\20240710-0001 ('+str(shot)+').csv',header=[0],skiprows=[1])
...
for shot in np.arange(startshot,maxshot):
    if shot in skipshots:
        continue
    #Load Picoscope file
    pico=pd.read_csv(datadirectory+'\Pico6\\20240710-0001 ('+str(shot)+').csv',header=[0],skiprows=[1])
