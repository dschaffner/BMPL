...
def load_picoscope_rest_07202022(shot_number, maxrange=1, scopenum=5, time_range=[-6.0, 194.0], location='', plot=False):
    ...
    meancutoff = 1000
    location = 'C:\\Users\\Josh0\\OneDrive - brynmawr.edu\\Documents\\1. Josh Documents\\Graduate School - Bryn Mawr College\\Plasma Lab (BMX) Research\\Analysis\\Data\\2022\\07202022\\'
