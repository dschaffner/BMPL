...
def load_picoscope_rest_09232022(shot_number, maxrange=1, scopenum=5, time_range=[-6.0, 194.0], location='', plot=False):
    ...
    meancutoff = 1000
    location = 'C:\\Users\\Josh0\\OneDrive - brynmawr.edu\\Documents\\1. Josh Documents\\Graduate School - Bryn Mawr College\\Plasma Lab (BMX) Research\\Analysis\\Data\\2022\\09232022\\'
    ...
    B3 = sp.cumtrapz(B3_probe, time_s)*1e4 #Gauss
    B4 = sp.cumtrapz(B4_probe, time_s)*1e4 #Gauss
    B5 = sp.cumtrapz(B5_probe, time_s)*1e4 #Gauss
    B6 = sp.cumtrapz(B6_probe, time_s)*1e4 #Gauss
