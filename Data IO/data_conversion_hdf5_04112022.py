...
testpicoshot=spio.loadmat(datadirectory+'Pico1\\20220411-0001 ('+str(1)+').mat')
...
for shot in np.arange(1,maxshot+1):
    if shot in skipshots:
        continue
    #Load Picoscope file
    pico1=spio.loadmat(datadirectory+'Pico1\\20220411-0001 ('+str(shot)+').mat')
...
for shot in np.arange(1,maxshot+1):
    if shot in skipshots:
        continue
    #Load Picoscope file
    pico2=spio.loadmat(datadirectory+'Pico2\\20220411-0001 ('+str(shot)+').mat')
...
for shot in np.arange(1,maxshot+1):
    if shot in skipshots:
        continue
    #Load Picoscope file
    pico3=spio.loadmat(datadirectory+'Pico3\\20220411-0001 ('+str(shot)+').mat')
...
for shot in np.arange(1,maxshot+1):
    if shot in skipshots:
        continue
    #Load Picoscope file
    pico4=spio.loadmat(datadirectory+'Pico4\\20220411-0001 ('+str(shot)+').mat')
...
for shot in np.arange(1,maxshot+1):
    if shot in skipshots:
        continue
    #Load Picoscope file
    pico5=spio.loadmat(datadirectory+'Pico5\\20220411-0001 ('+str(shot)+').mat')
