...
def load_picoscope_one_01122022(shot_number, maxrange=1, scopenum=1, time_range=[-6.0, 194.0], location='', plot=False):
...
#        sys.exit()
    ...
    location = 'C:\\Users\\Josh0\\Documents\\1. Josh Documents\\Graduate School - Bryn Mawr College\\Plasma Lab (BMX) Research\\Analysis\\Data\\2022\\01122022\\Pico1\\'
    ...
    B1 = sp.cumtrapz(B1_probe, time_us)*1e4 #Gauss
    B2 = sp.cumtrapz(B2_probe, time_us)*1e4 #Gauss
