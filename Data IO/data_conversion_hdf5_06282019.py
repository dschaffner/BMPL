...
import load_picoscope_bmx_06282019 as load
import numpy as np

filepath='C:\\Users\\dschaffner\\Dropbox\\Data\\BMPL\\BMX\\2019\\Correlation Campaign\\Encoding Converted for PC\\06282019\\processed\\'
filename='2kV_oddpos1to13_2ms_stuffdelay_10shots_probe_res_testing_06282019'
import h5py
...
run_info.create_dataset('Collection Dates',data='06282019')
...
channels=['pos7','pos9','pos11','pos13','pos15','pos17','pos19']
