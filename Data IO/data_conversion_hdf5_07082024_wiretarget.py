...
datadirectory='C:\\Users\\dschaffner\\Dropbox\\Data\\BMPL\\BMX\\2024\\07082024\\'

#numskipped=len(skipshots)
#numshots=maxshot-(startshot-1)-numskipped

#runfilename = 'Dataset4_wiretarget_1kV_1msstuff_0kAwire_40shots' #shots 7 to 48 skip 42,43
runfilename = 'Dataset4_wiretarget_1kV_1msstuff_2kAwire_40shots' #shots 58 to 98 skip 92
...
testpicoshot=pd.read_csv(datadirectory+'\pico1\\20240708-0001 ('+str(6)+').csv',header=[0],skiprows=[1])
...
for shot in np.arange(startshot,maxshot):
    if shot in skipshots:
        continue
    #Load Picoscope file
    pico=pd.read_csv(datadirectory+'\Pico1\\20240708-0001 ('+str(shot)+').csv',header=[0],skiprows=[1])
...
for shot in np.arange(startshot,maxshot):
    if shot in skipshots:
        continue
    #Load Picoscope file
    pico=pd.read_csv(datadirectory+'\Pico2\\20240708-0001 ('+str(shot)+').csv',header=[0],skiprows=[1])
...
for shot in np.arange(startshot,maxshot):
    if shot in skipshots:
        continue
    #Load Picoscope file
    pico=pd.read_csv(datadirectory+'\Pico3\\20240708-0001 ('+str(shot)+').csv',header=[0],skiprows=[1])
...
for shot in np.arange(startshot,maxshot):
    if shot in skipshots:
        continue
    #Load Picoscope file
    pico=pd.read_csv(datadirectory+'\Pico4\\20240708-0001 ('+str(shot)+').csv',header=[0],skiprows=[1])
...
for shot in np.arange(startshot,maxshot):
    if shot in skipshots:
        continue
    #Load Picoscope file
    pico=pd.read_csv(datadirectory+'\Pico5\\20240708-0001 ('+str(shot)+').csv',header=[0],skiprows=[1])
...
for shot in np.arange(startshot,maxshot):
    if shot in skipshots:
        continue
    #Load Picoscope file
    pico=pd.read_csv(datadirectory+'\Pico6\\20240708-0001 ('+str(shot)+').csv',header=[0],skiprows=[1])
