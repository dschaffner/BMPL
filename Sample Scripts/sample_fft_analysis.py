...
fsize = int(
    (data['pos1']['b']['z'][0, start_time_index:end_time_index].shape[0])/2)+1
...
for shot in np.arange(first_shot, last_shot+1):
    f, f0, comp1, pwr, mag1, phase1, cos_phase1, interval = spec.spectrum_wwind(
        data['pos1']['b']['z'][shot, start_time_index:end_time_index], timeB_s[start_time_index:end_time_index], window='hanning')
