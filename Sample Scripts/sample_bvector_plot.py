...
plt.arrow(0, 0, bz5[timestep], bt5[timestep],
          head_width=100, head_length=100, fc='k', ec='k')
plt.arrow(0, 0, bz5[timestep], 0, head_width=10,
          head_length=10, fc='blue', ec='blue', alpha=0.3)
plt.arrow(bz5[timestep], 0, 0, bt5[timestep], head_width=10,
          head_length=10, fc='red', ec='red', alpha=0.3)
