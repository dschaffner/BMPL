...
print(' ')
print(' ')
print('The array for B_theta of position 1 is: ',data['pos1']['b']['theta'].shape)
print('There are ',data['pos1']['b']['theta'].shape[0],' shots each ',data['pos1']['b']['theta'].shape[1], 'timesteps long.')
