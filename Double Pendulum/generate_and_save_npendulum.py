...
def integrate_pendulum(n, times,
    ...
    KM = mechanics.KanesMethod(A, q_ind=q, u_ind=u,
                               kd_eqs=kinetic_odes)
    #fr, fr_star = KM.kanes_equations(forces, particles) #for Sympy 1.0
    fr, fr_star = KM.kanes_equations(particles, forces) #for Sympy 1.10
