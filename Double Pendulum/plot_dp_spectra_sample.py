...
freq1, freq_alt1, comp1, pwr1, mag1, phase1, cos_phase1, dt1 = spec.spectrum_wwind(
    np.cos(theta1), time, window='hanning')
freq2, freq_alt2, comp2, pwr2, mag2, phase2, cos_phase2, dt2 = spec.spectrum_wwind(
    np.cos(theta2), time, window='hanning')
...
plt.semilogx(freq1[1:], pwr1[1:], color='blue',
             label=r'FFT[$\cos(\theta_{1})(t)$]')
plt.semilogx(freq2[1:], pwr2[1:], color='red',
             label=r'FFT[$\cos(\theta_{2})(t)$]')
