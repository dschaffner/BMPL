...
def double_pendulum_calc(tmax, dt, y0, p1, p2, g, edrift=0.05,savefile=False):
    ...
    if np.any(cumerr>edrift)==True:
        ...
        print('Accumulated Error Exceeds Threshold at timestep: '+str(passed_threshold))

    theta1=y[:,0]#angle [rad] pendulum 1 makes with vertical as function of time
    theta2=y[:,2]#angle [rad] pendulum 2 makes with vertical as function of time
