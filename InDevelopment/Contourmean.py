...
for probe in np.arange(5):
    ...
    for x in np.arange(20):
        ...
        stdB_0 = np.mean(dataB_0[start_time_index:end_time_index])
        stdB_1 = np.mean(dataB_1[start_time_index:end_time_index])
        stdB_2 = np.mean(dataB_2[start_time_index:end_time_index])
        stdB_3 = np.mean(dataB_3[start_time_index:end_time_index])
        stdB_4 = np.mean(dataB_4[start_time_index:end_time_index])
        stdB_5 = np.mean(dataB_5[start_time_index:end_time_index])
        stdB_6 = np.mean(dataB_6[start_time_index:end_time_index])
...
cs=plt.contourf(x,y,z,levels=500,cmap='plasma')
cbar=plt.colorbar()
cbar.set_label('B [G]', rotation=270, labelpad=15,fontsize=9)

plt.title("Average Mag. Field over 20 shots, 60-160us",fontsize=9)
...
savefile = 'blocker_scan_contour_mean.png'
